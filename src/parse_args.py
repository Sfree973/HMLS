...
parser.add_argument('--task_size', type=int, default=16,
                    help='task size (default: 256)')
parser.add_argument('--hard_size', type=int, default=2,
                    help='hard train triples kept size (default: 16)')
